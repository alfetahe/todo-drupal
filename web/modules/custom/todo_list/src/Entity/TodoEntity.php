 ...
 *     "list_builder" = "Drupal\todo_list\TodoEntityListBuilder",
 *     "views_data" = "Drupal\todo_list\Entity\TodoEntityViewsData",
 *     "translation" = "Drupal\todo_list\TodoEntityTranslationHandler",
 *
 *     "form" = {
 *       "default" = "Drupal\todo_list\Form\TodoEntityForm",
 *       "add" = "Drupal\todo_list\Form\TodoEntityForm",
 *       "edit" = "Drupal\todo_list\Form\TodoEntityForm",
 *       "delete" = "Drupal\todo_list\Form\TodoEntityDeleteForm",
 *     },
 *     "route_provider" = {
 *       "html" = "Drupal\todo_list\TodoEntityHtmlRouteProvider",
 *     },
 *     "access" = "Drupal\todo_list\TodoEntityAccessControlHandler",
 *   },
 *   base_table = "todo_entity",
 *   data_table = "todo_entity_field_data",
 *   translatable = TRUE,
 ...
 * )
 */
class TodoEntity extends ContentEntityBase implements TodoEntityInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['status']->setDescription(t('A boolean indicating whether the Todo entity is published.'))
      ->setDisplayOptions('form', [
